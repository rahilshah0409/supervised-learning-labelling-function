...
from segment_with_sa import create_event_vocab, get_events_from_masks_in_state, save_image_with_masks, run_segmentation_on_single_image
...
if __name__ == "__main__":
    ...
    events_for_every_ep = generate_event_labels_from_masks(trace_data, traces_dir, model_type, masks_for_ep_filename, img_base_filename, masks_for_every_ep)
    ...
    #     save_images_with_masks_and_events(results_dir + masks_pkl_filename, trace_img_dir, img_base_filename, events_ep_i, masks_imgs_dir)
